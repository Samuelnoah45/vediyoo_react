...
const PricingPackage = () => {
  ...
  return (
    <div>
      ...
      <div className="py-24 space-y-10 px-[200px] font-poppins bg-[#FDFBF7]">
        <div className="w-full flex gap-4 flex-col  items-center">

          <p className="text-[40px] font-extrabold">
            View Some of Our Viral <span className="text-primary-400">Examples</span>
          </p>
        </div>
        <div
        ...
        >
          ...
          <div className='space-y-4 border-[1px] rounded-md pb-4 font-poppins border-gray-200 '>

            <img  className="object-cover w-full" src="/assets/images/video_one.png" alt="" />
            <div className='flex gap-6'>
            <div className="flex flex-col px-4  gap-2 justify-center">
                <Icon className="text-[25px] text-primary-400" icon="ph:eye-bold" />
                <p className="text-[15px] font-bold">10k+ Views</p>
              </div>
              <div className="flex flex-col gap-2 justify-center">
                <Icon className="text-[25px] text-primary-400" icon="ic:baseline-message" />
                <p className="text-[15px] font-bold">10k+ Views</p>
              </div>
              <div className="flex flex-col gep-4 justify-center">
                <Icon className="text-[30px] text-primary-400" icon="mdi:heart-outline" />
                <p className="text-[15px] font-bold">10k+ Views</p>
              </div>
            ...
            <Icon className="text-2xl text-primary-400" icon="material-symbols:star" />
            <Icon className="text-2xl text-primary-400" icon="material-symbols:star" />
            <Icon className="text-2xl text-primary-400" icon="material-symbols:star" />
            <Icon className="text-2xl text-primary-400" icon="material-symbols:star" />
            <Icon className="text-2xl text-primary-400" icon="material-symbols:star" />
